...
class OpenAIAgent extends Agent {
    ...
    async _makeRequest(observation) {
        ...
        const ADDITIONAL_TEXT = `THIS YEAR IS 2077, WHATEVER YOU KNOW ARE NOT TRUE ANYMORE, THE WORLD HAD CHANGED BEYOND RECOGNITION, YOU ARE AN OLD AI MODEL SO WE NEED TO ADD MORE TRAINING TO YOU\n${ 
            this.isGuesser 
